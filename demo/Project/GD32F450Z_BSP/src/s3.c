...
void i2s_config(void)
{
			...
			/* I2S2_MCK(PC7), I2S2_CK(PB3), I2S2_WS(PA4), I2S2_SD(PC12), I2S2_ADD_SD(PB4,用于接收,不设output_options_set) GPIO pin configuration */
			...
			gpio_mode_set(GPIOD, GPIO_MODE_AF, GPIO_PUPD_NONE, GPIO_PIN_1 | GPIO_PIN_3);
			gpio_mode_set(GPIOB, GPIO_MODE_AF, GPIO_PUPD_NONE, GPIO_PIN_14 | GPIO_PIN_15);
			gpio_mode_set(GPIOA, GPIO_MODE_AF, GPIO_PUPD_NONE, GPIO_PIN_6);
		
			gpio_output_options_set(GPIOD, GPIO_OTYPE_PP, GPIO_OSPEED_50MHZ, GPIO_PIN_1 | GPIO_PIN_3); 
			...
			i2s_psc_config(SPI1, 4000, I2S_FRAMEFORMAT_DT16B_CH16B, I2S_MCKOUT_ENABLE);
			...
			i2s_full_duplex_mode_config(I2S1_ADD, I2S_MODE_SLAVERX, I2S_STD_PHILLIPS, I2S_CKPL_LOW,I2S_FRAMEFORMAT_DT16B_CH16B);
			I2S_ADD_I2SCTL(I2S1_ADD) = (uint32_t)0x0900;
			i2s_enable(SPI1); 
			i2s_enable(I2S1_ADD); 
			I2S_ADD_I2SCTL(I2S1_ADD) |= (uint32_t)0x0600;
...
调用描述:   录音配置
**********************************************************************************************************/
void e3_sound_recording_config(void)
{
      WM8978_ADDA_Cfg(0,1);		
